#!/usr/bin/env python
"""
SR Optimization for VBF Boosted HH → 4b Analysis (v0)
=======================================================
...
FIT_RANGE_H1 = (115, 145)  # restrict Gaussian fit to peak region
FIT_RANGE_H2 = (110, 140)
NBINS = 50
...
def plot_cut_scan_standalone(scan_results, optimal_cut, config_label,
    ...
    # Config label
    ax.text(0.05, 0.5, config_label.replace("_", " / "),
...
def plot_massplane_standalone(sig_m1, sig_m2, sig_w,
    ...
    # Indication of the MC_CAMPAIGNS / Tagger / Jet_Mode
    ax.text(0.66, 0.9, config_label.replace("_", " / "),
            fontsize=10, color='gray', transform=ax.transAxes)
...
"""
    ...
    print("=" * 70)
    print("SR Optimisation — VBF Boosted HH → 4b (v0)")
    print("=" * 70)
